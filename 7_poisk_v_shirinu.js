...
// Сложность в худшем случае для реализации с использованием матрицы смежности: O(|V|^2),
// где |V| - количество вершин. Эта оценка сложности возникает при поиске минимального расстояния до всех вершин в графе.
