...
// Сложность алгоритма:
// Рекурсивный метод: Временная сложность - O(N), где N - количество узлов в дереве.
// Пространственная сложность - O(H), где H - высота дерева (глубина).
// Итеративный метод: Временная сложность - O(N), где N - количество узлов в дереве.
// Пространственная сложность - O(M), где M - максимальное количество узлов в одном уровне дерева (ширина дерева).
